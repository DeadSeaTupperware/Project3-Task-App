    ...
    switch (habitStatus) {
      case "strong":
        setFilteredHabits(
          habits.filter(
            (habit) =>
              habit.strength.includes("strong") ||
              habit.strength.includes("neutral")
          )
        );
        break;
      case "weak":
        setFilteredHabits(
          habits.filter((habit) => habit.strength.includes("weak"))
        );
        break;
      default:
        ...
        <Flex>
          ...
          <TasksColumn>
            <Flex>
              ...
              <TasksFilterContainer>
                <TasksFilter onClick={(e) => habitStatusHandler("all")}>
                  All
                </TasksFilter>
                <TasksFilter onClick={(e) => habitStatusHandler("weak")}>
                  Weak
                </TasksFilter>
                <TasksFilter onClick={(e) => habitStatusHandler("strong")}>
                  Strong
                </TasksFilter>
              </TasksFilterContainer>
            </Flex>
