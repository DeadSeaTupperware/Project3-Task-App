    ...
    <div className="homepage">
      ...
      <main className="main-content">
        <section className="about-us">
          <h2>About Us</h2>
          <p>
            Welcome to Stive your ultimate solution for seamless scheduling and
          ...
          <p>
            At Stive, we understand the challenges of balancing personal and
          ...
          <p>
            ...
            scheduling, Stive was developed by a team of dedicated professionals
          ...
          <p>
            ...
            to make Stive the best scheduling tool available. Our dedicated
